                ...
                switch (interaction.options.getSubcommand()) {
                    case "online":
                        if (!serverConfig.onlineChannel) {
                            ...
                            interaction.reply({
                                content: "The bot is already tracking the amount of online users in a channel!",
                                ephemeral: true
                            });
                        }
                        break;
                    case "all":
                        if (!serverConfig.allChannel) {
                            ...
                            interaction.reply({
                                content: "The bot is already tracking the amount of all users in a channel!",
                                ephemeral: true
                            });
                        }
                        break;
                    case "bots":
                        if (!serverConfig.botChannel) {
                            ...
                            interaction.reply({
                                content: "The bot is already tracking the amount of bots in a channel!",
                                ephemeral: true
                            });
                        }
                }
                ...
                switch (interaction.options.getSubcommand()) {
                    case "online":
                        if (serverConfig.onlineChannel) {
                            ...
                            interaction.reply({
                                content: "The bot is not tracking the amount of online users!",
                                ephemeral: true
                            });
                        }
                        break;
                    ...
                    case "bots":
                        if (serverConfig.botChannel) {
                            ...
                            interaction.reply({
                                content: "The bot is not tracking the amount of bots!",
                                ephemeral: true
                            });
                        }
                        break;
